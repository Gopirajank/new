        ...
        <section id="about" class="about">
          <div className="contact" id="contact">
            ...
            <div className="email">
              ...
              <p className="sub">Chennai, India.</p>
              </div>
            <div className="email">
              ...
              <a style={{ textDecoration: "none", color: "#18d26e" }} href="mailto:gobirajank21@gmail.com"> gobirajank21@gmail.com </a></p>
              </div>
              <div className="email">
              ...
              <a style={{ textDecoration: "none", color: "#18d26e" }} href="https://www.linkedin.com/"> </a></p>
              </div>
